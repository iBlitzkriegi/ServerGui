...
class Ui_ServerGui(object):
    def setupUi(self, ServerGui):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 85, 188))
        ...
        self.verticalLayout_18.addWidget(self.server_options_table)
        ...
        self.whitelist_list_widget.addItem(item)
        ...
        item = QtWidgets.QListWidgetItem()
        self.banned_players_list_widget.addItem(item)
        ...
        item = QtWidgets.QListWidgetItem()
        self.banned_ips_list_widget.addItem(item)
    ...
    def retranslateUi(self, ServerGui):
        ...
        __sortingEnabled = self.whitelist_list_widget.isSortingEnabled()
        self.whitelist_list_widget.setSortingEnabled(False)
        item = self.whitelist_list_widget.item(0)
        item.setText(_translate("ServerGui", "Whitelist"))
        self.whitelist_list_widget.setSortingEnabled(__sortingEnabled)
        self.pushButton.setText(_translate("ServerGui", "Add"))
        __sortingEnabled = self.ops_list_widget.isSortingEnabled()
        self.ops_list_widget.setSortingEnabled(False)
        item = self.ops_list_widget.item(0)
        item.setText(_translate("ServerGui", "OPs"))
        self.ops_list_widget.setSortingEnabled(__sortingEnabled)
        self.pushButton_3.setText(_translate("ServerGui", "Add"))
        __sortingEnabled = self.banned_players_list_widget.isSortingEnabled()
        self.banned_players_list_widget.setSortingEnabled(False)
        item = self.banned_players_list_widget.item(0)
        item.setText(_translate("ServerGui", "Banned Players"))
        self.banned_players_list_widget.setSortingEnabled(__sortingEnabled)
        self.pushButton_6.setText(_translate("ServerGui", "Add"))
        __sortingEnabled = self.banned_ips_list_widget.isSortingEnabled()
        self.banned_ips_list_widget.setSortingEnabled(False)
        item = self.banned_ips_list_widget.item(0)
        item.setText(_translate("ServerGui", "Banned IPs"))
        self.banned_ips_list_widget.setSortingEnabled(__sortingEnabled)
        self.pushButton_7.setText(_translate("ServerGui", "Add"))
